...
class Profiles extends resource_1.APIResource {
    ...
    retrieve(profileID, params = {}, options) {
        ...
        return this._client.get((0, path_1.path) `/v3/profiles/${profileID}`, {
            ...options,
            headers: (0, headers_1.buildHeaders)([
                { ...(xProfileID != null ? { 'x-profile-id': xProfileID } : undefined) },
                options?.headers,
    ...
    update(profileID, params, options) {
        const { 'Idempotency-Key': idempotencyKey, 'x-profile-id': xProfileID, ...body } = params;
        return this._client.patch((0, path_1.path) `/v3/profiles/${profileID}`, {
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([
                {
    ...
    delete(profileID, params, options) {
        ...
        return this._client.delete((0, path_1.path) `/v3/profiles/${profileID}`, {
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([
    ...
    complete(profileID, params, options) {
        const { 'Idempotency-Key': idempotencyKey, 'x-profile-id': xProfileID, ...body } = params;
        return this._client.post((0, path_1.path) `/v3/profiles/${profileID}/complete`, {
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([
                {
...
Profiles.Campaigns = campaigns_1.Campaigns;
