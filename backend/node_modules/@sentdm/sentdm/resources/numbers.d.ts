...
export declare class Numbers extends APIResource {
     ...
     * ```
     */
    lookup(phoneNumber: string, params?: NumberLookupParams | null | undefined, options?: RequestOptions): APIPromise<NumberLookupResponse>;
}
/**
...
export declare namespace NumberLookupResponse {
    /**
     * The response data (null if error)
     */
    interface Data {
