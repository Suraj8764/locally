...
var _Sent_instances, _a, _Sent_encoder, _Sent_baseURLOverridden;
...
const numbers_1 = require("./resources/numbers.js");
...
const profiles_1 = require("./resources/profiles/profiles.js");
...
class Sent {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('SENT_BASE_URL'), apiKey = (0, env_1.readEnv)('SENT_DM_API_KEY'), ...opts } = {}) {
        _Sent_instances.add(this);
        _Sent_encoder.set(this, void 0);
        /**
         ...
         */
        this.numbers = new API.Numbers(this);
        /**
        ...
        if (apiKey === undefined) {
            throw new Errors.SentError("The SENT_DM_API_KEY environment variable is missing or empty; either provide it, or instantiate the Sent client with an apiKey option, like new Sent({ apiKey: 'My API Key' }).");
        }
        const options = {
            apiKey,
            ...opts,
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('SENT_LOG'), "process.env['SENT_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Sent_encoder, Opts.FallbackEncoder, "f");
        const customHeadersEnv = (0, env_1.readEnv)('SENT_CUSTOM_HEADERS');
        if (customHeadersEnv) {
            const parsed = {};
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Sent_instances, "m", _Sent_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Sent_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.Sent = Sent;
_a = Sent, _Sent_encoder = new WeakMap(), _Sent_instances = new WeakSet(), _Sent_baseURLOverridden = function _Sent_baseURLOverridden() {
    return this.baseURL !== 'https://api.sent.dm';
};
Sent.Sent = _a;
Sent.DEFAULT_TIMEOUT = 60000; // 1 minute
Sent.SentError = Errors.SentError;
Sent.APIError = Errors.APIError;
Sent.APIConnectionError = Errors.APIConnectionError;
Sent.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
Sent.APIUserAbortError = Errors.APIUserAbortError;
Sent.NotFoundError = Errors.NotFoundError;
Sent.ConflictError = Errors.ConflictError;
Sent.RateLimitError = Errors.RateLimitError;
Sent.BadRequestError = Errors.BadRequestError;
Sent.AuthenticationError = Errors.AuthenticationError;
Sent.InternalServerError = Errors.InternalServerError;
Sent.PermissionDeniedError = Errors.PermissionDeniedError;
Sent.UnprocessableEntityError = Errors.UnprocessableEntityError;
Sent.toFile = Uploads.toFile;
Sent.Webhooks = webhooks_1.Webhooks;
Sent.Users = users_1.Users;
Sent.Templates = templates_1.Templates;
Sent.Profiles = profiles_1.Profiles;
Sent.Numbers = numbers_1.Numbers;
Sent.Messages = messages_1.Messages;
Sent.Contacts = contacts_1.Contacts;
Sent.Me = me_1.Me;
